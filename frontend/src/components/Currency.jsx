...
const CurrencyCards = () => {
  return (
    <div className="bg-black text-white p-4 sm:p-6 md:p-8 lg:p-12 w-full max-w-7xl mx-auto shadow-lg">
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-6 sm:mb-8 md:mb-10 poppins text-center md:text-left">Currency & Payments</h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
        {/* Currency Exchange Card */}
        <div className="bg-[linear-gradient(180deg,_#1F1F1F_0%,_#000_100%)] p-5 sm:p-6 md:p-8 rounded-xl w-full shadow-md text-white border-2 border-gray-600 flex flex-col">
        ...
        <div className="bg-[linear-gradient(180deg,_#1F1F1F_0%,_#000_100%)] p-5 sm:p-6 md:p-8 rounded-xl w-full text-white shadow-md border-2 border-gray-600 flex flex-col">
