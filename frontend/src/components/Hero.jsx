...
const Hero = () => {
  return (
    <div>
      <section className="relative pt-4 bg-[radial-gradient(61.07%_61.07%_at_50%_38.93%,_#E7EDEF_0%,_#028B95_100%)] w-full h-[100vh] overflow-hidden max-w-full" data-aos="fade-down">
        {/* Navbar */}
        <Navbar />

        {/* Heading Section */}
        <div className="absolute inset-0 flex flex-col justify-center items-center z-10 text-center px-4 max-w-full overflow-x-hidden" data-aos="fade-up" data-aos-delay="100">
          <h1 className="text-white font-bold text-[28px] sm:text-[48px] md:text-[72px] lg:text-[95px] leading-tight drop-shadow-xl poppins" data-aos="zoom-in" data-aos-delay="200">
            About Us
          </h1>

          <h3 className="text-[14px] sm:text-[16px] md:text-[20px] text-white font-semibold mb-2 poppins">
            HARMYA - Explore at the comfort of your homes, making travel easy
          </h3>
          
          <p className="mt-6 mb-6 rounded-full bg-gradient-to-r from-black to-gray-800 text-white text-[12px] sm:text-[16px] md:text-[18px] h-[2.5rem] sm:h-[3rem] w-[90%] sm:w-[20rem] flex items-center justify-center opacity-75 poppins">
            A Journey Of Dreams From Home
          </p>

          <div  className="p-4 sm:p-6 bg-gradient-to-r from-black to-gray-900 text-white text-sm sm:text-base h-auto 
relative sm:absolute bottom-auto sm:bottom-10 inset-x-0 sm:inset-x-5 mt-6 sm:mt-0
opacity-80 rounded-2xl overflow-hidden shadow-lg max-w-full overflow-x-hidden" data-aos="fade-up" data-aos-delay="300">
      ...
      {/* Below Section */}
          ...
          <div className=" bg-[linear-gradient(0deg,_#000_0%,_#028B95_100%)] pt-8 h-auto sm:h-[6rem] mb-6">
