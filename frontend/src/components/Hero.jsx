...
const Hero = () => {
 ...
 <Navbar/>
  ...
  <div className="absolute inset-0 flex flex-col justify-center items-center z-10   text-center px-4 ">
    ...
    <h3 className='text-xl text-[#004247] font-semibold mb-2 text-[16px] '>HARMYA - Explore at the comfort of your homes, making trave</h3>
 
  <p className='static rounded-full bg-gradient-to-r from-black to-gray-800 text-white h-[3rem] w-[20rem] pt-2 opacity-75 '>A Journey Of Dreams From Home</p>
  <div className=' mt-4 p-2 bg-gradient-to-r from-black to-gray-900 text-xl text-white h-[15rem] absolute bottom-10 left-5 right-5  opacity-75 rounded-2xl overflow-hidden shadow-lg overflow-hidden  '>
