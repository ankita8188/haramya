...
export default function ContactPage() {
    ...
    <>
      <div className="min-h-screen bg-black text-white font-sans">
        {/* Header */}
          ...
          <header className="bg-[#00D5BE] text-white px-6 py-2 flex justify-between items-center">
            {/* Logo and Tagline */}
            <Link href="/" className="flex flex-col w-fit">
              <p className="text-4xl  island leading-none">Harmya</p>
              <p className="text-sm island italic ml-12">making travel easy</p>
            </Link>
  ...
  <p className="text-gray-300 mt-4 max-w-2xl text-base md:text-lg">
  ...
  <section className="mt-12 flex flex-col lg:flex-row gap-10 lg:gap-20 items-center justify-center w-full max-w-6xl">
    ...
    <div className="w-full max-w-md relative">
      ...
      <div className="min-h-screen w-full text-white flex flex-col items-center">
        ...
        <div className="w-full bg-black px-6 py-8 flex flex-col items-center">
          ...
          <div className="relative w-full max-w-5xl h-[400px] mb-10">
            <iframe
            ...
            {/* Floating Info Box */}
            <div className="absolute -left-20 top-14 bg-white text-black px-6 py-14 rounded-4xl shadow-2xl w-80 max-w-xs z-10 ">
      ...
      <div className="bg-black text-white w-full">
        ...
        {/* WhatsApp Banner */}
        <div className="bg-green-600 rounded-[60px] mx-14 md:mx-28 mt-10 mb-6 px-6 py-10 flex justify-between items-center shadow-lg">
          <h2 className="text-lg md:text-xl font-semibold">Contact us on Whatsapp</h2>
          <button className="bg-white text-green-600 font-medium px-4 py-3 w-40 rounded-[20px] hover:bg-gray-100 transition">
            Start Chat
          </button>
        </div>

        {/* Middle Section with Image + Form */}
        <div className="flex flex-col md:flex-row justify-between items-center px-6 md:px-24 py-10 gap-10">

          {/* Lord Shiva Image */}
          <div className="w-full md:w-1/2">
            <Image
              src="/cont2.jfif" // Put image in public folder
              alt="Lord Shiva"
              width={400}
              height={300}
